...
/* update data into local storage by index */
...
/* set page type need for local storage data update
used in registration for reload window page and show data it to list  */
